package mwongela.songbook.settings.sync
...
import mwongela.songbook.system.filesystem.saveInputStreamToFile
import mwongela.songbook.util.formatTimestampDate
import mwongela.songbook.util.formatTimestampTime
            ...
            .addOnSuccessListener { googleAccount: GoogleSignInAccount ->
                ...
                val googleDriveService =
                    Drive.Builder(NetHttpTransport(), GsonFactory(), credential)
                        .setApplicationName("mwongela.songbook")
                        .build()
