...
import mwongela.songbook.admin.HttpRequester
...
import mwongela.songbook.send.SongLanguageDetector
...
class AntechamberService(
    ...
    companion object {
        private const val antechamberApiBase = "https://antechamber.chords.mwongela.dev/api/v4"
